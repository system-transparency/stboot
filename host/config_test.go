...
func TestConfigUnmarshalJSON(t *testing.T) {
	tests := []struct {
		...
		{
			name: "$ID used in OSPkgPointer but ID unset",
			json: `{
				"network_mode":"dhcp",
				"host_ip":null,
				"gateway":null,
				"dns":null,
				"ospkg_pointer":"http://server.com/$ID/foo",
				"identity":null,
				"authentication":null,
				"network_interfaces":null,
				"bonding_mode":null,
		...
		{
			name: "$AUTH used in OSPkgPointer but Auth unset",
			json: `{
				"network_mode":"dhcp",
				"host_ip":null,
				"gateway":null,
				"dns":null,
				"ospkg_pointer":"http://server.com/$AUTH/foo",
				"identity":null,
				"authentication":null,
				"network_interfaces":null,
				"bonding_mode":null,
		...
		{
			name: "Missing field ospkg_pointer",
			json: `{
				"network_mode":"static",
				"host_ip":"127.0.0.1/24",
				"gateway":"127.0.0.1",
